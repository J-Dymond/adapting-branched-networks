...
class MobileNetV3(nn.Module):
    ...
    '''
    def __init__(self, mode='small', classes_num=1000, input_size=224, input_channels = 3, width_multiplier=1.0, dropout=0.2, BN_momentum=0.1, zero_gamma=False):
        '''
        ...
        first_layer = nn.Sequential(
            nn.Conv2d(in_channels=input_channels, out_channels=input_channels_num, kernel_size=3, stride=s, padding=1, bias=False),
