...
annoPrep("data/sat-6/y_test_sat6.csv", "data/sat-6/y_test.csv")
annoPrep("data/sat-6/y_train_sat6.csv", "data/sat-6/y_train.csv")
...
csv2img("data/sat-6/X_train_sat6.csv", pathTrainX)
csv2img("data/sat-6/X_test_sat6.csv", pathTestX)
